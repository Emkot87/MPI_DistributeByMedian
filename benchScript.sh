...
echo "--------------------------------------------------------262144 points with 386 diamensions of randomly generated values 0-100"


./makeRand.out 262144 386 

mpirun -np 2 ./mpiRand.out 262144 386 

mpirun -np 4 ./mpiRand.out 262144 386 

mpirun -np 8 ./mpiRand.out 262144 386 


echo "--------------------------------------------------------524288 points with 386 diamensions of randomly generated values 0-100"


./makeRand.out 524288 386 

mpirun -np 2 ./mpiRand.out 524288 386 

mpirun -np 4 ./mpiRand.out 524288 386 

mpirun -np 8 ./mpiRand.out 524288 386 
